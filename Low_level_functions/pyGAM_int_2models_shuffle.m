function [gam_grid_both, shuffle_both] = pyGAM_int_2models_shuffle(y_array_bvd, X_arrayboth_vel, x2shuffle, np, lams, shift)
    ...
    gam_grid_both = pyGAM2struct(gamboth); % Convert GAM model to struct
    ...
    for i = 1:50
        ...
        gam_grid_both_sh = pyGAM2struct(gamboth); % Convert shuffled GAM model to struct
    ...
    reject_h0 = p_val < 0.05 / 3; % Bonferroni correction
    
    % Store results in gam_grid_both struct
