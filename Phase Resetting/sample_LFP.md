sampleLFP.mat contains a sample file to run the scripts in this folder. It consists of mean LFP signal across channels for a single recording session of Subject P
